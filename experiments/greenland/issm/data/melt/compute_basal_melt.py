...
max_vel = np.load('../velocity/IS_vel.npy')
...
print('Scaling basal velocity by {:.2f}'.format(vel_scalefactor))
vel = max_vel * vel_scalefactor

# Then also compute basal melt rate
basalmelt = vel*drivingstress / rho_w/L
np.save('IS_friction_melt.npy', basalmelt)
